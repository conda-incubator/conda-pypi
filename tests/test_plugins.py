...
def test_extract_whl_as_conda_called(tmp_env: TmpEnvFixture, conda_cli: CondaCLIFixture, mocker: MockerFixture):
    
    spy=mocker.spy(extract_whl_or_tarball.extract_whl, "extract_whl_as_conda_pkg")
    with tmp_env() as prefix:
        try:
            conda_cli("install", "https://files.pythonhosted.org/packages/45/7f/0e961cf3908bc4c1c3e027de2794f867c6c89fb4916fc7dba295a0e80a2d/boltons-25.0.0-py3-none-any.whl",  "-p", prefix)
        except:
            pass
